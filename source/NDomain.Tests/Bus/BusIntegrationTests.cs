...
namespace NDomain.Tests.Bus
{
	public class BusIntegrationTests
	{
		...
		[Test]
		public void CanRegisterAllHandlersInAssembly()
		{
			...
			Assert.Contains(typeof(CounterEventsHandler), actual);
			Assert.Contains(typeof(TestCommandHandler), actual);
		}

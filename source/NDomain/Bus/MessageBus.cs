...
namespace NDomain.Bus
{
   public class MessageBus : IMessageBus
   {
      ...
      public async Task Send(IEnumerable<Message> messages)
      {
         ...
         {
            // ensure there are subscriptions bound to this message
            ...
            else
            {
			   ...
			   throw new ApplicationException($"Attempt to send message {message.Name} but no subscriptions were found");
			}
         }
